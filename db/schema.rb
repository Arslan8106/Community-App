...
ActiveRecord::Schema[7.0].define(version: 2022_08_04_132433) do
  create_table "articles", force: :cascade do |t|
    ...
    t.index ["membership_id"], name: "index_articles_on_membership_id"
  end
  ...
  add_foreign_key "articles", "memberships"
